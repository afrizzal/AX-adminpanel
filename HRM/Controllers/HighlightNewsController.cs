...
{
    public class HighlightNewsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.HighlightNews.ToList());
        }
        ...
        public ActionResult GetDataList()
        {
            ...
            sSql = "SELECT ID, ID [NO], TITLE [TITLE], SUBTITLE [SUBTITLE] FROM HighlightNews";
            if (msg == "")
            {
                DataTable tbl = new ClassConnection().GetDataTable(sSql, "HighlightNews");
                ...
                if (tbl.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in tbl.Rows)
                    {
                        ...
                        foreach (DataColumn col in tbl.Columns)
                        {
                            ...
                            {
                                item = "<a class='text-primary' href='" + Url.Action("Form/" + dr["ID"].ToString(), "HighlightNews") + "'>" + item + "</a>";
                            }
